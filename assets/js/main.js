...
const Elemento=document.getElementById("name_user")


function myDisplayer(something) {
    document.getElementById("name_user").innerHTML = something;
  }

  
function hazlo(callBack){
    var salida='aaron'
    ...
    axios.get('http://localhost:5000/user/', {
        ...
        .then(function(res) {
          if(res.status==200)salida=res.data.data[0].name
        })
        callBack(salida)
